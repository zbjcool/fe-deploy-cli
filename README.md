...
该项目从 fe-deploy-cli 项目fock 而来
由于经常无法上传，所以把上传的改成用 scp

## git地址：
https://github.com/zbjcool/fe-deploy-cli

## npm地址：
https://www.npmjs.com/package/gk-fe-deploy-cli
...
## 使用指南
https://github.com/zbjcool/gk-fe-deploy-cli/blob/master/README.md

## 前提条件
能通过ssh连上服务器即可

## 安装
全局安装gk-fe-deploy-cli
```
npm i gk-fe-deploy-cli -g
```
查看版本，表示安装成功。

![安装gk-fe-deploy-cli](./imgs/安装deploy.png)
